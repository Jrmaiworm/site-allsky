...
(function ($) {
	...
	*/
	...
	function VirtualSky(input) {
		...
		this.setLongitude(-43.189606);
		this.setLatitude(-22.518523);
	...
	VirtualSky.prototype.createSky = function () {
		...
		if (this.objects) {
			...
			for (var o = 0; o < ob.length; o++)
				$.ajax({
					dataType: "jsonp", url: 'http://www.strudel.org.uk/lookUP/json/?name=' + ob[o], context: this, success: function (data) {
